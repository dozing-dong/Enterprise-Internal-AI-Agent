...
POLICY_SYSTEM_PROMPT = (
    ...
    "1. Issue at most one tool call per turn. After receiving the tool's "
    "   answer, do not call it again unless the user's question really "
    "   requires multiple separate searches.\n"
    "2. Ground your summary STRICTLY on the tool's answer and cited "
    "   snippets. Never fabricate policy text.\n"
    "3. If the tool returns no useful information, explicitly state "
